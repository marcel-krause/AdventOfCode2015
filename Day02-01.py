...
+------------------------------------+
	...
	# Read the input file and calculate the area
	fullArea = 0
	with open('Day02-01_input.dat', 'r') as content_file:
		...
		for currLine in allLines:
			...
			fullArea += 3*packageDimensions[0]*packageDimensions[1] + 2*packageDimensions[0]*packageDimensions[2] + 2*packageDimensions[1]*packageDimensions[2]
	print(fullArea)
